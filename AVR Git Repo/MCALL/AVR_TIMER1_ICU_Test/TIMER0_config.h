...
typedef enum{
TIMER0_FCPU_DIVIDED_BY_1=1,TIMER0_FCPU_DIVIDED_BY_8,TIMER0_FCPU_DIVIDED_BY_64,TIMER0_FCPU_DIVIDED_BY_256,TIMER0_FCPU_DIVIDED_BY_1024,TIMER0_EXTERNAL_SOURCE_FALLING_EDGE,TIMER0_EXTERNAL_SOURCE_RISING_EDGE
}TIMER0_CLOCK_SELECT;
